...
import org.esgi.core.payment.domain.PriceFactory;
import org.esgi.core.payment.domain.SubscriptionPlanFactory;
import org.esgi.core.payment.domain.model.payment.DefaultPayment;
...
import org.esgi.core.payment.domain.model.payment.TransactionId;
...
import org.esgi.core.payment.domain.model.subscription.SubscriptionType;
import org.esgi.kernel.annotations.Service;
import org.esgi.kernel.cqs.CommandHandler;

@Service
public class ProcessMembershipPaymentHandler implements CommandHandler<ProcessMembershipPayment, PaymentId> {

  private final PaymentRepository paymentRepository;
  private final PaymentService    paymentService;

  public ProcessMembershipPaymentHandler(PaymentRepository paymentRepository, PaymentService paymentService) {
  ...
  public PaymentId handle(ProcessMembershipPayment command) {
    ...
    MethodOfPaymentType methodOfPaymentType = MethodOfPaymentType.fromString(command.methodOfPayment);
    Price price = PriceFactory.create(subscriptionPlan);
    Payment paymentToProceed = DefaultPayment.of(TransactionId.of(command.transactionId), memberId, paymentId,
                                                 methodOfPaymentType, subscriptionPlan, price, false);
