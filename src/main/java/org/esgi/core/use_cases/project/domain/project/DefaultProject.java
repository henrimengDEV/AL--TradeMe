...
public class DefaultProject implements Project {
  ...
  public DefaultProject(ProjectId projectId, ContractorId contractorId, String name, Period period,
                        List<ProjectJob> requiredJobs, DailyRemuneration dailyRemuneration,
                        Address address) {
  ...
  public static DefaultProject of(ProjectId projectId, ContractorId contractorId, String name,
                                  Period period, List<ProjectJob> requiredJobs,
                                  DailyRemuneration dailyRemuneration, Address address) {
    return new DefaultProject(projectId, contractorId, name, period, requiredJobs,
                              dailyRemuneration, address);
  }
  ...
  public String toString() {
    return "DefaultProject{" +
        ...
        ", dailyRemuneration=" + dailyRemuneration +
        ", address=" + address +
        ", isActive=" + isActive +
        '}';
  }
