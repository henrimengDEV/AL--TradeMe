...
public final class EducationCertificate {
  ...
  private EducationCertificate(EducationCertificateId educationCertificateId, JobType jobType, String name) {
    this.educationCertificateId = educationCertificateId;
    this.jobType = jobType;
    this.name = name;
  }

  public static EducationCertificate of(EducationCertificateId educationCertificateId, JobType jobType, String name) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(educationCertificateId, that.educationCertificateId) && jobType == that.jobType
  ...
  public String toString() {
    return "EducationCertificate{" + "educationCertificateId=" + educationCertificateId + ", jobType=" + jobType
        + ", name='" + name + '\'' + '}';
  }
}
