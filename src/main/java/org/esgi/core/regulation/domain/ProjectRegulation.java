...
public class ProjectRegulation implements Regulation {
  ...
  private ProjectRegulation(RegulationId regulationId, String description, ProjectId projectId) {
    this.regulationId = regulationId;
    this.description = description;
    this.project = projectId;
  }

  public static ProjectRegulation of(RegulationId regulationId, String description, ProjectId projectId) {
  ...
  public String toString() {
    return "ProjectRegulation{" + "regulationId=" + regulationId + ", description='" + description + '\'' + ", pro="
        + project + '}';
  }
}
