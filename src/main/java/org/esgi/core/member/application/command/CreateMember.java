...
public final class CreateMember implements Command {
  ...
  public CreateMember(String lastname, String firstname, String login, String password, String memberRole,
                      AddressDTO address, String mail, String geographicZoneOfAvailability, List<String> competences) {
