...
public enum JobType {
  ARCHITECT("architect", EducationCertificateId.of(1)), ELECTRICIAN("electrician", EducationCertificateId.of(2)), MASON(
      "mason", EducationCertificateId.of(3)), PLUMBER("plumber", EducationCertificateId.of(4)), CARPENTER("carpenter",
                                                                                                          EducationCertificateId.of(
                                                                                                              5));

  private final String                 role;
  private final EducationCertificateId educationCertificateId;

  JobType(String role, EducationCertificateId educationCertificateId) {
    this.role = role;
